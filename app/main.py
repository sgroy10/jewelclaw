...
*6.* Pricing Engine (Making Charges)
*7.* Morning Brief (Daily 9 AM Update)
*8.* Industry News
*9.* Invite a Friend
*10.* About JewelClaw
...
I track jewelry industry news from top sources every 4 hours.

Type *news* to see the latest headlines — brand launches, store openings, market updates, and more.

High-priority news gets sent to you automatically!""",
...
async def handle_onboarding(db: AsyncSession, user, message_body: str) -> str:
    ...
    NOT_A_NAME = {
        ...
        "onboarding", "portfolio", "news", "quote", "price",
